...
_G.packer_plugins = {
  ...
  catppuccin = {
    loaded = true,
    path = "/home/martin/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  ["lsp_lines.nvim"] = {
    loaded = true,
    path = "/home/martin/.local/share/nvim/site/pack/packer/start/lsp_lines.nvim",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/martin/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["presence.nvim"] = {
    loaded = true,
    path = "/home/martin/.local/share/nvim/site/pack/packer/start/presence.nvim",
  ...
  ["telescope-file-browser.nvim"] = {
    loaded = true,
    path = "/home/martin/.local/share/nvim/site/pack/packer/start/telescope-file-browser.nvim",
  ...
  ["vim-devicons"] = {
    loaded = true,
    path = "/home/martin/.local/share/nvim/site/pack/packer/start/vim-devicons",
